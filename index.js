...
function filterUnfundedOnly() {
    ...
    // Log the result to find out the number of games
...
const displayStr = `A total of $${totalAmountRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently, ${unfundedGamesCount} game${unfundedGamesCount === 1 ? ' remains' : 's remain'} unfunded. We need your help to fund these amazing games!`;
